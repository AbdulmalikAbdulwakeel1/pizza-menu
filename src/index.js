...
function Menu(){
    ...
    return(
        ...
        <main className="menu">
            ...
            {numpizzas  >0 ? (
                <>
                <p>This is abdulmalik's italian  kitchen 6 creative 
                kitchen to cook from, All from our store  </p>
...
function Pizza({pizzaObj}){
    ...
    return(
        ...
        <img src={pizzaObj.photoName} alt="Pizza spinacci"/>
        <div>
        <h3>{pizzaObj.name}</h3>
...
function Order({closeHour,openHour}){
    return(
        <div className="order">
        <p>we are open from {openHour}:00 to {closeHour}:00. Come visit
         us or order online
         </p>
